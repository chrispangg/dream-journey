          ...
          <TableBody>
            {trips.map((trip) => (
              <TableRow key={trip._id}>
                ...
                <TableCell align="center">{dayjs(trip.startDate).format('DD/MM/YYYY')}</TableCell>
                <TableCell align="center">{dayjs(trip.endDate).format('DD/MM/YYYY')}</TableCell>
                <TableCell>
                  <Box mb={1}>
                    <Button
                      size="small"
                  ...
                  <Box>
                    <Button size="small" classes={{ root: classes.button }} variant="contained" color="secondary" onClick={() => handleWarningClickOpen(trip._id)}>
                      DELETE
                    </Button>
                  </Box>
                  <Box>
          ...
          <Container maxWidth="md">
            <Box p={3} borderRadius={15}>
              <Box display="flex" alignItems="center">
                <Box width="100%">
                  <TextField label="Destination" variant="outlined" fullWidth margin="dense" size="medium" name="destination" onInput={handleInputChange} value={formValue.locationName} />
                </Box>
              </Box>
              <Box display="flex" alignItems="center">
                <Box width="50%" mr={2}>
